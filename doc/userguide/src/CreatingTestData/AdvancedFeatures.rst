...
`Python built-in function <https://docs.python.org/2/library/functions.html#enumerate>`.

:name:`:FOR` :name:`IN ENUMERATE` loops work just like regular :name:`:FOR` loops,
...
.. table:: For in enumerate comparison
   :class: example
   ================= ================ =============== ============= =================== =======
   Test Case         Action           Argument        Argument      arg                 arg
   ================= ================ =============== ============= =================== =======
...
For In Enumerate loops are new in Robot 2.9.
...
is derived from the
`Python built-in zip function <https://docs.python.org/2/library/functions.html#zip>`.
...
For In Zip loops are new in Robot 2.9, and are named after a Python built-in function.
