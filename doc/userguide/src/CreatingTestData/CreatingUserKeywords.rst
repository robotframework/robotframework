...
User keywords can be tagged similarly as test cases and `library keywords`_
support `tags <Keyword tags_>`__ as well.

Setting tags using dedicated settings
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~

Similarly as when `tagging test cases`_, there are two settings affecting
user keyword tags:
...
.. note:: The :setting:`Keyword Tags` setting is new in Robot Framework 6.0.
          With earlier versions all keyword tags need to be specified using
          the :setting:`[Tags]` setting.
