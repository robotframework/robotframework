...
Robot Framework 5.1 beta 1 was released on Friday September 2, 2022.
...
Robot Framework 5.1 beta 1 contains built-in support for these languages in addition
...
- When keywords accepting embedded arguments are used so that arguments are passed as
  variables, variable values are checked against possible custom regular expressions (`#4069`_).
  This more strict behavior causes failures if values do not match.
...
.. list-table::
    ...
    * - `#4069`_
      - enhancement
      - medium
      - Variables acting as embedded arguments are not checked against regular expression
      - beta 1
    * - `#4262`_
      - enhancement
      - medium
...
Altogether 42 issues. View on the `issue tracker <https://github.com/robotframework/robotframework/issues?q=milestone%3Av5.1>`__.
...
.. _#4069: https://github.com/robotframework/robotframework/issues/4069
