*** Settings ***
Suite Setup       Run Tests    --variable WINDOWS:${WINDOWS} --ConsoleMarkers OFF    standard_libraries/builtin/import_resource.robot standard_libraries/builtin/import_variables.robot    default options=
