...
Linking
    ...
    ...    <a href="http://example.com">No title</a> is needed.
...
Fenced code blocks do not work inside admonitions
    [Documentation]    Fences are handled by a preprocessor that runs before
    ...
    ...                that it is correct.
    <p>Fenced code blocks do not, because fences are handled by a preprocessor
    ...    that runs before admonitions are parsed:</p>
