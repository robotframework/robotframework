...
Verify That Suite Name is not a file like name
    ...
    Should Not Be Equal    ${SUITE_NAME}    Parent Init Suite.Child Suite01 Name.Child0101
    

Verify Suite Name
    Should Be Equal    ${SUITE_NAME}    Parent Init Suite.Child Suite01 Name.Child 0102 Suite