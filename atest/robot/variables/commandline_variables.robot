...
Run Test Data
    ...
    ${options} =    Catenate    --variable NORMAL_TEXT:Hello    --variable no_colon    -v ESCAPED:${escaped .replace(' ', 'SPACE')}    --variable eScApEd2:${escaped2}    -E quot:QUOT
    ...    -E apos:APOS    -E dollar:DOLLAR    -E amp:AMP    -E space:SPACE    -E exclam:EXCLAM    -E curly1:CURLY1
    ...    -E curly2:CURLY2
