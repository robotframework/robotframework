...
Variable section: parings errors
    ...
    ...    Setting variable '\&{INVALID_DICT_TYPE1: int=list[int}' failed: Parsing type
    ...    'dict[int, list[int]' failed: Error at end: Closing ']' missing.
    ...    pattern=False
    Error In File
    ...    6    variables/variable_types.robot    23
    ...    Setting variable '\&{INVALID_DICT_TYPE2: int=listint]}' failed: Parsing type
    ...    'dict[int, listint]]' failed: Error at index 18: Extra content after 'dict[int, listint]'.
    ...    pattern=False
    Error In File
...
User keyword: invalid type
    Check Test Case    ${TESTNAME}
    Error In File
    ...    0    variables/variable_types.robot    323
...
User keyword: Invalid assignment with kwargs k_type=v_type declaration
    Check Test Case    ${TESTNAME}
    Error In File
    ...    1    variables/variable_types.robot    327
