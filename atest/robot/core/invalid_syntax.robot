...
Library Imports
    ...
    Verify Error  Replacing variables from setting 'Library' failed: Resolving variable '\${unicodeï¿½ï¿½ï¿½}' failed: Non-existing variable '\${unicodeï}'.  Settings
...
Variables In Variable Table
    Verify Error  Setting variable 'Invalid Variable Name' failed: Invalid variable name 'Invalid Variable Name'.  Variables
...
My Setup
    ...
    ${PATH} =  Normalize Path  ${DATADIR}/core/invalid_syntax.html
