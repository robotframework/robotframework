...
Invalid Suite Setting
    ...
    Check Log Message  ${ERRORS[0]}  Error in file '${base}${/}__init__.txt': Non-existing setting 'Invalid'.  ERROR
    Check Log Message  ${ERRORS[1]}  Error in file '${base}${/}sub_suite_with_init_file${/}__INIT__.txt': Non-existing setting 'Invalid In Sub'.  ERROR
