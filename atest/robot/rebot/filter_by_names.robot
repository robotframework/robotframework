*** Settings ***
Documentation   Tests for --test and --suite options for Rebot
...
No Matching Tests In Matching Suites
    ...
    ${stderr} =  Get Stderr
    Should Be Equal  ${stderr.strip()}  [ ERROR ] Suite 'Many Tests & Suites' contains no tests named 'first', 'nonex' or '*one' in suites 'nonex' or 'suites'.${USAGE_TIP}
