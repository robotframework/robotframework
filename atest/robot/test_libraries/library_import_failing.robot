...
Invalid Library
    ...
    ...    Importing test library '${path}' failed:
...
Initializing Fails Without Arguments
    ...
    ...    Initializing test library 'InitializationFailLibrary' with no arguments failed:
...
Initializing Fails With Arguments
    ...
    ...    Initializing test library 'InitializationFailLibrary' with arguments [[] 1 | arg2=2 ] failed:
...
Initializing Java Library Fails
    ...
    ...    Initializing test library 'InitializationFailJavaLibrary' with no arguments failed:
