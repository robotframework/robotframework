...
Keyword From New Style Class Library
    ...
    Syslog Should Contain    Imported library 'newstyleclasses.NewStyleClassLibrary' with arguments [ ] (version <unknown>, class type, test case scope, 1 keywords

Keyword From Library With Metaclass
    Check Test Case    Keyword From Library With Metaclass
    Syslog Should Contain    Imported library 'newstyleclasses.MetaClassLibrary' with arguments [ ] (version <unknown>, class type, test case scope, 2 keywords
