*** Settings ***
Documentation   Tests for libs logging during import and in init.
...
Logging during import via stdout and stderr
...
Logging during init via logging API
