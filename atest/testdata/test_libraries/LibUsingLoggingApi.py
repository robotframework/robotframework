...
def write_messages_to_log_and_console():
    ...
    logger.info("Info message to log and console", also_console=True)
    ...
    logger.warn("Warn message only to log", also_console=False)
    logger.error("Error message only to log", also_console=False)
