...
Run Keyword In Multiple Levels And With UK
    [Documentation]  FAIL Expected Failure
    Run Keyword  Run Keyword  Run Keyword  My UK  Run Keyword  My UK  My UK  My UK
    ...  Run Keyword  Fail  Expected Failure

Run Keyword In For Loop
    [Documentation]  FAIL Expected failure in For Loop
    :FOR  ${kw}  ${arg1}  ${arg2}  IN  Log  hello from for loop  INFO
    ...  BuiltIn.Comment  hi  you  My UK  Log  hei maailma
    \  Run Keyword  ${kw}  ${arg1}  ${arg2}
    :FOR  ${kw}  ${arg}  IN  Log  hello from second for loop  Fail  Expected failure in For Loop
    \  Run Keyword  ${kw}  ${arg}
