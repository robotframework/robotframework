...
class JsModelBuilder(object):
    ...
    def __init__(self, log_path=None, split_log=False,
        ...
        self._context = JsBuildingContext(log_path, split_log, prune_input_to_save_memory, auto_expand_keywords)
    ...
    def build_from(self, result_from_xml):
        ...
        return JsExecutionResult(
            ...
            auto_expand_ids=self._context.auto_expand_keyword_ids
        )
