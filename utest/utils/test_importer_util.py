...
class TestInvalidImportPath(unittest.TestCase):
    ...
    def test_non_existing(self):
        ...
        assert_raises_with_msg(
            ...
            Importer("test file").import_class_or_module_by_path,
            path,
        )
    ...
    def test_non_absolute(self):
        ...
        assert_raises_with_msg(
            ...
            Importer("file").import_class_or_module_by_path,
            path,
        )
    ...
    def test_invalid_format(self):
        ...
        assert_raises_with_msg(
            ...
            Importer("xxx").import_class_or_module_by_path,
            path,
        )
...
class TestImportClassOrModule(unittest.TestCase):
    ...
    def test_invalid_item_from_existing_module(self):
        ...
        assert_raises_with_msg(
            ...
            self._import,
            "pythonmodule.submodule.attribute",
            "xxx",
        )
    ...
    def test_logging_when_importing_module(self):
        ...
        logger.assert_message(
            f"Imported test library module 'classes' from '{LIBDIR / 'classes'}'."
        )
    ...
    def test_logging_when_importing_python_class(self):
        ...
        logger.assert_message(
            f"Imported class 'ExampleLibrary' from '{LIBDIR / 'ExampleLibrary'}'."
        )
...
class TestImportModule(unittest.TestCase):
    ...
    def test_logging(self):
        ...
        logger.assert_message(
            f"Imported module 'ExampleLibrary' from '{LIBDIR / 'ExampleLibrary'}'."
        )
...
Traceback (most recent call last):
  File "{path}", line 5, in <module>
    ...
    def test_structure(self):
        error = self._failing_import("NoneExisting")
        message = (
            "Importing 'NoneExisting' failed: ModuleNotFoundError: "
    ...
    def _get_traceback(self, error):
        return "\n".join(
            self._block(error, "Traceback (most recent call last):", "PYTHONPATH:")
        )
...
class TestInstantiation(unittest.TestCase):
    ...
    def test_when_importing_by_name(self):
        ...
        lib = Importer().import_class_or_module(
            "ExampleLibrary", instantiate_with_args=()
        )
...
""",
    ...
    def test_instantiate_failure(self):
        assert_raises_with_msg(
            DataError,
            "Importing xxx 'ExampleLibrary' failed: "
            "Xxx 'ExampleLibrary' expected 0 arguments, got 3.",
            Importer("XXX").import_class_or_module,
            "ExampleLibrary",
            ["accepts", "no", "args"],
        )
