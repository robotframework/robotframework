...
class TestCustomMetadataCommandLineIntegration(unittest.TestCase):
    ...
    def test_case_sensitivity_filtering(self):
        ...
        settings = FileSettings(custom_metadata=["Owner", "priority"])  # lowercase priority
        
        self.assertTrue(settings.should_include_custom_metadata("Owner"))
        self.assertTrue(settings.should_include_custom_metadata("priority"))  # exact match
        self.assertFalse(settings.should_include_custom_metadata("Priority"))  # different case
        self.assertFalse(settings.should_include_custom_metadata("OWNER"))     # different case
    ...
    def test_empty_and_none_filtering(self):
        ...
        self.assertTrue(settings_none.should_include_custom_metadata(""))  # even empty string
    ...
    def test_whitespace_handling_in_names(self):
        ...
        self.assertFalse(settings.should_include_custom_metadata("My  Name"))  # double space
