...
class TestItemLists(unittest.TestCase):
    ...
    def test_repr(self):
        assert_equal(
            repr(ItemList(int, items=[1, 2, 3, 4])),
            "ItemList(item_class=int, items=[1, 2, 3, 4])",
        )
        assert_equal(
            repr(CustomItems(Object)),
