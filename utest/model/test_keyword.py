...
class TestKeyword(unittest.TestCase):
    ...
    def test_keyword_custom_metadata_basic(self):
        ...
        self.assertEqual(dict(kw.custom_metadata), {"Owner": "Alice", "Type": "Utility"})
    ...
    def test_keyword_custom_metadata_serialization(self):
        ...
        self.assertEqual(data["custom_metadata"], {"Component": "Core", "Priority": "High"})
    ...
    def test_keyword_custom_metadata_with_copy_operations(self):
        ...
        self.assertEqual(dict(bound.custom_metadata), {"Original": "True", "Version": "1.0"})
