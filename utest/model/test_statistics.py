...
class TestStatisticsSimple(unittest.TestCase):
    ...
    def test_total(self):
        verify_stat(self.statistics.total.critical, 'Critical Tests', 2, 1, 1)
        verify_stat(self.statistics.total.all, 'All Tests', 2, 1, 1)
...
class TestStatisticsNotSoSimple(unittest.TestCase):
    ...
    def test_tags(self):
        ...
        expected = [('smoke', 2, 2, 0, True),
                    ('a title', 0, 0, 0, None, 'none NOT t1'),
                    ('t? & smoke', 2, 2, 0, None, 't? & smoke'),
                    ('t1', 3, 2, 0),
                    ('t2', 2, 1, 0)]
