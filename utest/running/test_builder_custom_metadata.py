...
class TestCustomMetadataBuilder(unittest.TestCase):
    ...
    def test_build_with_special_characters_in_metadata(self):
        ...
        *** Keywords ***
        ...
        self.assertEqual(keyword.custom_metadata["Description"], "Uses special chars: !@#$%^&*()")
    ...
    def test_build_with_unicode_custom_metadata(self):
        ...
        *** Test Cases ***
        ...
        self.assertEqual(test.custom_metadata["Owner"], "Alice")
        self.assertEqual(test.custom_metadata["Description"], "This test uses unicode: äöü")
    ...
    def test_build_error_handling_with_invalid_syntax(self):
        ...
        *** Test Cases ***
        ...
        self.assertEqual(test.custom_metadata["Edge-Case"], "Value with \"quotes\" and 'apostrophes'")
