...
class TestUserKeywordCustomMetadata(unittest.TestCase):
    ...
    def test_custom_metadata_property_creation(self):
        ...
        self.assertEqual(
            dict(kw.custom_metadata), {"Owner": "Alice", "Complexity": "Medium"}
        )
    ...
    def test_custom_metadata_to_dict_serialization(self):
        ...
        self.assertEqual(
            ...
            {"Owner": "Alice", "Priority": "High", "Component": "API"},
        )
    ...
    def test_custom_metadata_with_embedded_args(self):
        ...
        kw.custom_metadata = {"Type": "Embedded", "Parameters": "1", "Usage": "Common"}
    ...
    def test_custom_metadata_with_arguments_and_body(self):
        ...
        kw = UserKeyword(
            "Login With Credentials", ["${username}", "${password}"], owner=self.res
        )
    ...
    def test_custom_metadata_bind_preservation(self):
        ...
        self.assertEqual(
            dict(bound_kw.custom_metadata),
            {"Owner": "Alice", "Priority": "High", "Component": "Core"},
        )
    ...
    def test_custom_metadata_empty_values(self):
        ...
        kw = UserKeyword("Test Keyword", owner=self.res)
        kw.custom_metadata = {"EmptyString": "", "Whitespace": "   ", "Owner": "Alice"}
    ...
    def test_custom_metadata_large_values(self):
        ...
        kw.custom_metadata = {"LargeValue": large_value, "NormalValue": "Small"}
    ...
    def test_custom_metadata_ordering(self):
        ...
        kw = UserKeyword("Test Keyword", owner=self.res)
        kw.custom_metadata = {"First": "1", "Second": "2", "Third": "3"}
