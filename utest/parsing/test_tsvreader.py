...
''')
        ...
        assert_equal(self.tcf.setting_table.name, 'SettING')
        assert_equal(self.tcf.setting_table.header, ['SettING','Value','V'])
...
''')
        ...
        for act, exp in zip(actual, expected):
            assert_equal(act.name, '${v}')
            assert_equal(act.value, [exp])
